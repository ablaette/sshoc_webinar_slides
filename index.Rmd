...
- HTML documents with scrollable fulltext [-> example](./gallery/fulltext_doc.html)
- Slides with `fulltext` htmlwidget [-> example](./gallery/fulltext_slides.html)
...
- Validating sentiment analyses with interactive KWIC tables [-> example](file:///Users/andreasblaette/Lab/github/ValidationWorkflows/docs/sentiment_analysis.html#17)
- Evaluate topic models with flexdashboard [-> example](https://polmine.github.io/gallery/topicmodel_flexdashboard.html)
- Understanding the data behind cooccurrence graphs [-> example](./gallery/unga_gradget.html)
...
- Annotate cooccurrence graphs [-> example](./gallery/unga_gradget.html)
